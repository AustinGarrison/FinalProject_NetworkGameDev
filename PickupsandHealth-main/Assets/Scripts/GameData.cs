...
public class GameData : NetworkBehaviour {
    ...
    private int[] playerSprites = new int[]
    {
        0,
        1,
        2
    ...
    {
        int nextSprite = playerSprites[spriteIndex];
        spriteIndex += 1;
        if (spriteIndex > playerSprites.Length - 1)
        {
            spriteIndex = 0;
        }
        return nextSprite;
    ...
    public void AddPlayerToList(ulong clientId) {
        allPlayers.Add(new PlayerInfo(clientId, NextColor(), NextSprite(), true));
    }
